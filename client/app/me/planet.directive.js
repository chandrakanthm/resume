...
app.factory('planetaryjs', function planetaryjs() {
...
app.directive("planet", ['planetaryjs', function(planetaryjs) {
    return {
        restrict: 'E',
        scope: {
            data: '=?'
        },
        template: '<canvas id="rotatingGlobe" width="800 " height="800" style="width: 800 px;height: 800 px;cursor: move;">' + '</canvas>',
        link: link
    };
    ...
    function link(scope, element, attrs) {
        ...
        globe.loadPlugin(planetaryjs.plugins.earth({
            topojson: { file: '/app/me/world-110m-withlakes.json' },
            oceans: { fill: '#87ceeb' },
            land: { fill: '#ffffff' },
            borders: { stroke: '#000000', lineWidth: 0.35 }
        }));
